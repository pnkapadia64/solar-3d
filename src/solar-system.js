...
class SolarSystem {
  ...
  setupCelestialBodies() {
    // Sun
    const sun = new CelestialBody(SUN_RADIUS, "./assets/sun.jpg");
    sun.setName("sun");
    ...
    // Earth
    const earth = new CelestialBody(EARTH_RADIUS, "./assets/earth.jpg");
    earth.setName("earth");
    ...
    // Moon
    const moon = new CelestialBody(MOON_RADIUS, "./assets/moon.jpg");
    moon.setName("moon");
